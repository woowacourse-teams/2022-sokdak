insert into member (username, nickname, password, role_type) values ('chris', 'chrisNickname', '6297d64078fc9abcfe37d0e2c910d4798bb4c04502d7dd1207f558860c2b382e', 'ADMIN');
insert into member (username, nickname, password, role_type) values ('xldk78', 'east', '433abc1016172c0dac0955d03ee8820d3efa6dce8c80d56883bcafbaca941956', 'ADMIN');
...
insert into board (title, board_type) values ('Hot 게시판', 'SPECIAL');
insert into board (title, board_type) values ('자유게시판', 'NORMAL');
insert into board (title, board_type) values ('포수타', 'NORMAL');
insert into board (title, board_type) values ('감동크루', 'NORMAL');
